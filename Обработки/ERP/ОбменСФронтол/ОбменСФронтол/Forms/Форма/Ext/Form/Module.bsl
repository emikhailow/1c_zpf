...
Процедура СформироватьОтчетОРозничныхПродажах(СтруктураПараметры)
	...
	ОРПСобственнаяПродукцияОбъект 		= СоздатьЗаполнитьОтчетОРозничныхПродажах(СтруктураПараметры);
	ОРПСобственнаяПродукцияОбъект.Дата 	= ДатаДокумента;
...
&НаСервере
Функция СоздатьЗаполнитьОтчетОРозничныхПродажах(СтруктураПараметры)
	...
	ТЗПродажи.Свернуть("Код, Разрез, Цена","Количество, Сумма");
	Для Каждого СтрокаОтчет Из ТЗПродажи Цикл
	...
	ТЗОплаты.Свернуть("Код, Карта", "Сумма");
	
	НайденныеСтроки = ТЗОплаты.НайтиСтроки(Новый Структура("Код", 2));
	...
	НайденныеСтроки = ТЗОплаты.НайтиСтроки(Новый Структура("Код", 3));
	Для Каждого Строка Из НайденныеСтроки Цикл
	...
	НайденныеСтроки = ТЗОплаты.НайтиСтроки(Новый Структура("Код", 4));
	Для Каждого Строка Из НайденныеСтроки Цикл
